...
<div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
        ...
        <div id="sidebar-scroll">
            ...
            <div class="sidebar-content">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        <a class="nav-submenu" data-toggle="nav-submenu" style="cursor:pointer;" onclick="window.location.href='createnew'"><i class="si si-lock"></i><span class="sidebar-mini-hide"></span>Create account</a>
                        <li class="open">
                            ...
                            <ul>
                                <li>
                                    <a class="active" href="">Change Information</a>
                                </li>
                                <li>
    ...
    <main id="main-container">
        ...
        <div class="content">
            ...
            <h2 class="content-heading">Add new admin</h2>
            <div class="block">
                <div class="block-header block-header-default">
                    <p class="text-danger">( Please fill in all textfields )</p>
                </div>
                <div class="block-content">
                        ...
                        <div class="col-xl-6">
                            ...
                            <form class="js-validation-bootstrap" action="be_forms_validation.html" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-middlename" name="val-middlename" placeholder="Enter a middlename">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="js-datepicker form-control" id="example-datepicker1" name="val-birthday" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="mm/dd/yy" placeholder="mm/dd/yy">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-skill">Image (Optional)<span class="text-danger"> *</span></label>
                                    <div class="col-8">
